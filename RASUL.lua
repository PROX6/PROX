...
--   This Is The 𝗥𝗮𝗦𝗨𝗟 𝗞𝗮𝗥𝗘𝗺 ⇣  @RRRRWV .   --
--                - Prox -                 --
--        -- https://t.me/RRRRWV --         --
------------------------------------------------ 
...
local Msg_Id2 = data.message_id_/1823672541/0.5
...
SendText(DevId,Text,msg.id_/1823672541/0.5,'md') 
...
local msg_id = msg.id_/1823672541/0.5
...
{{text = '♡ Siria team .', url="t.me/RRRRWV"}},
}
local msg_id = msg.id_/1823672541/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/1823672541/0.5) 
else 
end 
end,nil) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ 𝘼𝙃𝙈𝙀𝘿 𝙎𝙄𝙍𝙄𝘼  𖣌 ',url="t.me/KXK_X"}},
{{text = '  ◍ 𝙆𝘼𝙎𝘼𝙃𝘼 ↺  𖣌 ', url="t.me/MR_AAS"}},
{{text = '   ◍ 𝙈𝙔 𝘾𝙃𝘼𝙉𝙀𝙀𝙀𝙇 𖢑  𖣌  ', url="t.me/RRRRWV"}},
}
https.request("https://api.telegram.org/bot"..TokenBot..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/RRRRWV/1469&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
sendText(msg.chat_id_,Name,msg.id_/1823672541/0.5,'md')
 end end
...
SendText(msg.chat_id_,Text,msg.id_/1823672541/0.5,'md')
else
...
local msg_id = msg.id_/1823672541/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/KXK_X&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Prox     --
